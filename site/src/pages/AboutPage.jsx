...
import { asset, JOIN_CTA_HREF, pageHref } from '../asset';
  ...
  return (
    <div>
      <PageHero
        ...
        actions={<a className="btn btn-primary" href={JOIN_CTA_HREF}>Join Pack 351 →</a>}
      />
      <QuickFacts id="facts" />
      ...
      <div id="charter" style={{ background: 'var(--navy-light)', borderTop: '1px solid var(--border)', padding: '36px 0' }}>
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap' }}>
          ...
          <a className="btn btn-primary" href={JOIN_CTA_HREF}>Join Pack 351 →</a>
        </div>
      </div>
